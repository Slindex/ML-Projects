...
def downloadHousingData() -> None:
    ...
    ## Returns
    A California Housing .csv dataset in a 'data' directory
    """
    ...

def downloadCaliforniaMap() -> None:
    """
    Downloads the California map .shp files, create the 'data' directory if not exists and finally extracts the content from the zip file.

    ## Parameters
    None

    ## Returns
    Relevant California map shape files in a 'data' directory
    """
    ...
...
def barGraph(filename: str, labels: ndarray, values: ndarray, tittle: str, xlabel: str, ylabel: str, color: str='#329D9C') -> None:
    ...
    ## Returns
    A .png image containing the bar graph saved in a 'images' directory
    """
    ...
